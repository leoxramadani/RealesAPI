...
namespace RealesApi.Migrations
{
    ...
    [Migration("20250408224656_RemovedLinkPropertyWithTableWhatsSpecial")]
    partial class RemovedLinkPropertyWithTableWhatsSpecial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealesApi.Models.Faq", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.Faqtype", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.OtherImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.Property", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.PropertyWhatsSpecialLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.Purpose", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("RealesApi.Models.Faq", b =>
                {
                    b.HasOne("RealesApi.Models.Faqtype", "FaqType")
                        .WithMany("Faqs")
            ...
            modelBuilder.Entity("RealesApi.Models.Property", b =>
                {
                    b.HasOne("RealesApi.Models.Condition", "Condition")
                        .WithMany("Properties")
                        .HasForeignKey("ConditionId")
                        .HasConstraintName("FK__Property__Condit__73BA3083")
                        .IsRequired();

                    b.HasOne("RealesApi.Models.PropertyType", "PropertyType")
                        .WithMany("Properties")
                        .HasForeignKey("PropertyTypeId")
                        .HasConstraintName("FK__Property__Proper__75A278F5")
                        .IsRequired();

                    b.HasOne("RealesApi.Models.Purpose", "Purpose")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("RealesApi.Models.PropertyOtherImage", b =>
                {
                    b.HasOne("RealesApi.Models.OtherImage", "OtherImages")
